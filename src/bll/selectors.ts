...
//  auth
export const selectAuthNewPasswordValue = (state: AppRootStateType) =>
...
// signUp
export const selectSignUpIsRegistration = (state: AppRootStateType) =>
...
export const selectCardsCardsTotalCount = (state: AppRootStateType) =>
  state.cards.cardsTotalCount;
export const selectCardsCardsParamsPageCount = (state: AppRootStateType) =>
  state.cards.params;
export const selectCardsCardsCardsTotalCount = (state: AppRootStateType) =>
  state.cards.cardsTotalCount;

// profile
export const selectProfileProfileId = (state: AppRootStateType) =>
  state.profile.profile._id;

// packs
export const selectPacksParams = (state: AppRootStateType) => state.packs.params;
export const selectPacksCardsPacksTotalCount = (state: AppRootStateType) =>
